    ...
    <div className="bg-[#f8fafc] text-[#1a365d] min-h-screen">
      ...
      >
        <div className="container mx-auto px-6 md:px-20">
          <h2 className="text-3xl font-bold text-[#496580] mb-8">1. Information We Collect</h2>
          <p className="text-lg text-[#496580] mb-6">
            We collect the following types of information when you use PaperSphere:
          </p>
          ...
          <h2 className="text-3xl font-bold text-[#496580] mb-8">2. How We Use Your Information</h2>
          <p className="text-lg text-[#496580] mb-6">
          ...
          <h2 className="text-3xl font-bold text-[#496580] mb-8">3. Data Sharing and Disclosure</h2>
          <p className="text-lg text-[#496580] mb-6">
          ...
          <h2 className="text-3xl font-bold text-[#496580] mb-8">4. Data Security</h2>
          <p className="text-lg text-[#496580] mb-6">
          ...
          <h2 className="text-3xl font-bold text-[#496580] mb-8">5. Your Rights</h2>
          <p className="text-lg text-[#496580] mb-6">
          ...
          <h2 className="text-3xl font-bold text-[#496580] mb-8">6. Cookies</h2>
          <p className="text-lg text-[#496580] mb-6">
            We use cookies to enhance your experience on PaperSphere. You can manage or disable cookies through your browser settings, but this may affect platform functionality.
          </p>

          <h2 className="text-3xl font-bold text-[#496580] mb-8">7. Third-Party Links</h2>
          <p className="text-lg text-[#496580] mb-6">
          ...
          <h2 className="text-3xl font-bold text-[#496580] mb-8">8. Changes to This Policy</h2>
          <p className="text-lg text-[#496580] mb-6">
          ...
          <p className="text-lg text-[#496580] mb-6">
            If you have any questions about this Privacy Policy, please contact us at <a href="mailto:support@papersphere.com" className="text-[#496580] hover:underline font-semibold">support@papersphere.com</a>.
          </p>
        </div>
      </motion.section>
    </div>
