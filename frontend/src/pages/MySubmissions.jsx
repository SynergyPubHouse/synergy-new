...
const MySubmissions = () => {
	...
	const handleBuildPdf = (manuscriptId, mergedFileUrl) => {
		if (mergedFileUrl) {
			...
			// Mark this manuscript as having built PDF
	...
	const renderNotes = (manuscript) => {
		...
		return (
			<div className="mt-4 p-4 bg-[#f8fafc] rounded-lg border border-[#e2e8f0]">
				<h3 className="text-lg font-semibold text-[#496580] mb-3">
					{title}
				</h3>
						...
						{notes.map((note, index) => (
							...
							>
								...
								<div className="mt-2 flex justify-between items-center">
									<span className="text-sm text-[#496580]">
	...
	if (loading) {
		return (
			<div className="min-h-screen bg-[#f8fafc] flex items-center justify-center">
				<div className="text-[#496580] text-xl">Loading...</div>
			</div>
		);
	}
		...
		<div className="min-h-screen bg-[#f8fafc] p-6 text-[#1a365d]">
			<div className="max-w-6xl mx-auto">
				<div className="flex justify-between items-center mb-8">
					<h1 className="text-3xl font-bold text-[#496580] font-serif">
						My Submissions
					</h1>
					<Link
						to="/manuscript"
						className="px-4 py-2 bg-[#496580] hover:bg-[#3a5269] text-white font-semibold rounded-lg transition-colors"
					>
				...
				{manuscripts.length === 0 ? (
					<div className="text-center py-8 bg-white rounded-lg border border-[#e2e8f0]">
						<p className="text-[#496580]">
					...
					<div className="space-y-6">
						{manuscripts.map((manuscript) => (
							...
							>
								{/* Title Section */}
								<h2 className="text-xl font-bold text-[#496580] mb-4 text-center border-b border-[#e2e8f0] pb-4">
									{manuscript.title}
								</h2>

								{/* Content Section */}
								<div className="grid grid-cols-3 gap-4">
									{/* Left Section - Paper Type */}
									<div className="flex items-center justify-center">
										<div className="text-lg font-semibold text-[#496580]">
											{manuscript.type}
										</div>
									</div>
									...
									<div className="flex flex-col space-y-3 items-center">
										<button
											...
											className="w-full px-4 py-2 bg-[#496580] hover:bg-[#3a5269] text-white font-semibold rounded-lg transition-colors"
										>
											Build PDF
										</button>
										<button
			...
			{showConfirmation && (
				<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
					<div className="bg-white p-6 rounded-lg max-w-md w-full mx-4 border border-[#e2e8f0]">
						<h3 className="text-xl font-bold text-[#496580] mb-4">
							Warning!
						</h3>
						<p className="text-[#496580] mb-6">
						...
						<div className="flex justify-end space-x-4">
							<button
								...
								className="px-4 py-2 bg-[#f8fafc] text-[#496580] rounded-lg hover:bg-gray-100 transition-colors border border-[#e2e8f0]"
							>
								Cancel
							</button>
							<button
