...
const editorialMembers = [
  ...
  { name: 'Dr. P. William', affiliation: 'Sanjivani University, India || Victorian Institute of Technology, Australia || Amity University Dubai, UAE', specialization: 'Artificial Intelligence Machine Learning Deep Learning Cloud Computing Cyber Security', role: 'Associate Editors' },
  ...
  { name: 'Karan Alang', affiliation: 'Independent Researcher, CA USA 95014', specialization: 'Data Engineering, Data Science, Big Data, Cloud Computing, ML/AI', role: 'Area Editors' },
  ...
  { name: 'ARUN KUMAR MAURYA', affiliation: 'IIT ROORKEE INDIA', specialization: 'COMPUTER, ELECTRICAL AND ENERGY SCIENCE', role: 'Area Editors' },
...
const BiographyDrawer = ({ isOpen, onClose, person }) => {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 right-0 h-full w-full max-w-xl bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out overflow-hidden ${isOpen ? 'translate-x-0' : 'translate-x-full'
          }`}
      >
        {/* Header */}
        <div className="bg-gradient-to-br from-[#00796b] via-[#00897b] to-[#004d40] p-6 text-white relative overflow-hidden">
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-1 -right-1 bg-yellow-400 rounded-full p-1.5 shadow-lg">
                  <svg className="w-4 h-4 text-[#00796b]" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div>
                ...
                <p className="text-white/80 text-sm mt-1">{person.designation}</p>
          ...
          <div className="flex gap-4 mt-5 pt-4 border-t border-white/20">
            <div className="text-center">
              <p className="text-2xl font-bold">{person.role === 'Editor-in-Chief' ? '18+' : '24+'}</p>
              <p className="text-xs text-white/70">Years Exp.</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold">{person.researchInterests?.length || 0}</p>
              ...
              <div className="pt-4 border-t border-gray-100">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {person.expertise.map((item, index) => (
                    ...
                    >
                      <svg className="w-4 h-4 text-[#00796b] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
...
const LeadershipCard = ({ person, isPrimary = false, onViewBio }) => (
  <div className={`relative overflow-hidden rounded-2xl ${isPrimary
    ...
    <div className="flex items-center gap-5">
      ...
      <div className="relative">
        ...
        {/* Verified Badge */}
        <div className="absolute -bottom-1 -right-1 bg-yellow-400 rounded-full p-1.5 shadow-lg">
          <svg className="w-3 h-3 text-[#00796b]" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
          </svg>
        </div>
      </div>
    ...
    <div className="flex justify-center mb-6">
      <div className="relative w-32 h-32">
        <svg className="w-full h-full transform -rotate-90">
          ...
          <circle cx="64" cy="64" r="56" stroke="#00796b" strokeWidth="12" fill="none"
            strokeDasharray={`${71 * 3.52} ${100 * 3.52}`} strokeLinecap="round" />
        </svg>
            ...
            <div className="bg-gradient-to-br from-[#e0f7fa] to-[#b2ebf2] rounded-xl p-5 border border-[#00796b]/10">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-[#00796b]">{editorialMembers.length + 2}</span>
                </div>
                <div className="flex justify-between items-center">
        ...
        <div className="flex-1">
          ...
          <div className="mt-10 p-5 bg-gray-50 rounded-xl border-l-4 border-[#00796b]">
            <p className="text-sm text-gray-600">
              <strong className="text-[#00796b]">Note:</strong> All members of the Editorial Board have identified their affiliated institutions or organizations,
              along with the corresponding country or geographic region. The publisher remains neutral with
