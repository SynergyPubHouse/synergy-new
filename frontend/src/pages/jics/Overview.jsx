...
const metrics = [
  { label: "EiC", value: "Meenu Gupta" },
  { label: "Frequency", value: "Three iss./year" },
  { label: "Final Decision", value: "30 days" },
  { label: "Acceptance Rate", value: "20%" },
  { label: "Plagiarism", value: "<15%" },
  { label: "Language", value: "English" },
  { label: "Review Process", value: "Double-Blind" },
  { label: "Copyright", value: "CC-BY 4.0" },
  { label: "ISSN (online)", value: "3139-3616" },
];
...
const Overview = () => (
  <section className="flex flex-col lg:flex-row gap-8 items-start">
    ...
    <div className="flex-1 min-w-0">
      ...
      <div className="space-y-6">
        ...
        <p className="text-[#212121] text-lg leading-relaxed text-justify">
          ...
          application domains. The journal emphasizes originality, relevance,
          and scientific rigor, and is committed to contributing to the global
          body of knowledge in intelligent technologies.
        </p>
        <p className="text-[#212121] text-lg leading-relaxed text-justify">
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              ...
              <tr className="border-b border-gray-100">
                ...
                <td className="px-6 py-4 text-sm text-gray-700">3139-3616</td>
              </tr>
              <tr className="border-b border-gray-100">
                <td className="px-6 py-4 text-sm text-gray-700 bg-gray-50">
                  Format
              ...
              <tr className="border-b border-gray-100">
                ...
                <td className="px-6 py-4 text-sm text-gray-700">
                  ...
                  Learning, Data Science, Computational Intelligence, Internet
                  of Things (IoT), Cloud Computing, Cybersecurity, Software
    ...
    <aside className="w-full lg:w-60 flex-shrink-0 sticky top-[calc(50vh-220px)]">
      <div className="bg-white rounded-2xl shadow-md border border-gray-200 overflow-hidden">
        <div className="bg-[#00796b] px-5 py-4">
        ...
        <ul className="divide-y divide-gray-100">
          {metrics.map(({ label, value }) => (
            <li
              key={label}
              className="flex items-center justify-between gap-3 px-5 py-3 hover:bg-[#f0faf9] transition-colors"
            >
              <span className="text-xs font-semibold text-[#00796b] uppercase tracking-wider whitespace-nowrap">
                {label}
              </span>
              <span className="text-sm text-[#212121] text-right">{value}</span>
            </li>
          ))}
        </ul>
      </div>
