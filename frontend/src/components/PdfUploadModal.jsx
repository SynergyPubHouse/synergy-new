...
function PdfUploadModal({
  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      formData.append("separateIssue", separateIssue ? "true" : "false");
      // Issue info
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex border-b bg-gray-50">
          <button
            ...
            className={`flex-1 py-4 px-6 text-sm font-semibold relative transition-all ${
              activeTab === "pdf"
                  ...
                  {pdfAuthorsList.map((author, index) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={() =>
                          setPdfAuthorsList(
                            pdfAuthorsList.filter((_, i) => i !== index),
                          )
                        }
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 border-2 rounded-lg"
                  placeholder="Special Issue on AI in Healthcare"
                />
              </div>
        ...
        <div className="p-6 border-t bg-gray-50 flex justify-between items-center">
          <div className="flex flex-wrap gap-4 text-sm">
            <span
              className={
                selectedPdfFile ? "text-green-600 font-bold" : "text-gray-400"
              }
            >
            ...
            {pdfCorrespondingAuthor && (
              <span className="text-indigo-600 font-bold">
                Corresp: {pdfCorrespondingAuthor}
              </span>
            )}
          </div>
          ...
          <div className="flex gap-3">
            ...
            >
              {uploadingPdf ? <>Publishing...</> : <>Publish Article</>}
            </button>
          </div>
        </div>
      </div>
