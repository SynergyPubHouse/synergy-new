...
const Navbar = () => {
  ...
  <div className="flex items-center gap-2 whitespace-nowrap">
    ...
    <span className="text-base font-semibold">e-ISSN:</span>
    <span className="text-base font-bold">3139-3616</span>
  </div>
  ...
  <div className="flex items-center gap-2 whitespace-nowrap">
    ...
    <span className="text-base font-semibold">ESTD Year:</span>
