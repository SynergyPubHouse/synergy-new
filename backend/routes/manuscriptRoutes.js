...
router.post("/manuscripts/preview", auth, manuscriptController.previewManuscript);
router.get("/manuscripts/my-submissions", auth, manuscriptController.getMySubmissions);
